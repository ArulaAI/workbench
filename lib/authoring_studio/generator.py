...
from .models import Generation, RFC_MODULES, TEMPLATES
...
""" + CONTRACTS[operation["kind"]]
        ...
        result = llm_complete(messages=[{"role": "system", "content": system}, {"role": "user", "content": text}],
                              response_model=Generation, model=model, project_root=self.root,
