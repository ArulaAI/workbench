...
from .models import Clarification, Generation, INITIAL_DOCUMENT_MODELS, RFC_MODULES, TEMPLATES
...
""" + CONTRACTS[operation["kind"]]
        ...
        result = llm_complete(messages=[{"role": "system", "content": system}, {"role": "user", "content": text}],
                              response_model=INITIAL_DOCUMENT_MODELS[operation["kind"]] if head is None else Generation, model=model, project_root=self.root,
