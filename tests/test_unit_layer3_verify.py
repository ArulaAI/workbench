...
check("architect: has structural architecture", "Structural Architecture" in arch_result)
...
check("coherence: preserves legacy structural overlap", "Structural and File Overlap" in coh_result)
